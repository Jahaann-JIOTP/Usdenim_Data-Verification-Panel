...
const PageContent = () => {
  ...
  const [dropdownSearch, setDropdownSearch] = useState<string>(""); // New state for dropdown search
  ...
  const handleMeterChange = (value: string) => {
    ...
    setStatusFilter("");
    setCurrentPage(1);
    setDropdownSearch(""); // Reset dropdown search on selection
  };

  // Filter meters based on dropdown search
                          ...
                          <Listbox.Options className="absolute mt-1 max-h-48 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/10 focus:outline-none z-20">
                            <div className="px-2 py-1 sticky top-0 bg-white border-b border-gray-200">
                              <input
                                ...
                                className="w-full px-2 py-1 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[#1A68B2]"
                                autoFocus
                              />
                            </div>
