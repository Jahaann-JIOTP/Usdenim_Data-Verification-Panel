...
const PageContent = () => {
  const [selectedMeter, setSelectedMeter] = useState<string>("");  const [meters, setMeters] = useState<Meter[]>([]);
  ...
  const fetchMeters = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        //   console.log("duplicate meter names", duplicateMeterNames);
        // }
        // if (duplicateUniqueKeys.length > 0) {
        //   console.log("duplicate unique keys", duplicateUniqueKeys);
        // }
